<?php
    ...
    $user=$_GET[user];
    $query2 = "SELECT * FROM student_info where User_ID='$user'";
    ...
    <div class="container">
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="form">
                ...
                <div class="input_feild">
                    <level>Name</level>
                    <input type="text" value="<?php echo $result[Stu_Name]; ?>" class="input" name="name" required>
                </div>
...
<?php
    ...
    {   
        ...
        $phn   = $_POST['phone'];
        $email = $_POST['email'];
        $query0="UPDATE student_info SET Stu_Name='$name',  Par_Add='$par', Pre_Add='$pst', Gender='$gen', Phone='$phn', Email='$email' where User_ID='$user'";
        $data0=mysqli_query($conn,  $query0);
        if($data0)
        {
            echo "
                <script> 
                window.location.assign('studentdb.php');
