...
<body>
    <header>
      ...
      <div class="main">
        <a href="signup.php" class="user"><i class="ri-user-fill"></i>Sign UP</a>
        ...
        <div class="center">
            ...
            <form action="#" method="POST">
                <div class="form">
                    ...
                    <div class="signup">Don't have User ID?<a href="signup.php" class="link">SignUp here</a></div>
                </div>
            </form>
        </div>   
</body>
...
<?php
    ...
    if(isset($_POST['login']))
    {
        $user=$_POST['userid'];
        $email=$_POST['email'];
        $query3="SELECT * FROM student_info where User_ID='".$user."' &&  Email='".$email."'";
