...
<?php
    ...
    if(isset($_POST['signup']))
    {
        ...
        $query1="INSERT INTO student_info (Stu_img, Stu_Name, Par_Add, Pre_Add, Gender, Phone, Email) VALUES ('$folder', '$name', '$par', '$pst', '$gen', '$phn', '$email')";
        ...
        if($data1)
        {
            ...
            $query3="UPDATE student_info SET User_ID='".$User_id."' where Email='".$email."'";
